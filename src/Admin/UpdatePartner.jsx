...
export default function UpdatePartner() {
        ...
        const getPartnerdetail = async () => {
            try {
              const response = await databases.getDocument(
                ...
                partnerId // Replace with your Document ID
              );
              setPartnerdetail(response); // Returns an array of document
 ...
 const handleUpdate = async (e) => {
    ...
    const updatedData = {
        image: image || partnerdetail.image
    };
            ...
            <div className='p-3 max-w-6xl mx-auto flex-1 w-full'>
                ...
                <div className='p-4 flex gap-4 justify-between overflow-x-scroll scrollbar'>
                    <span>
                        ...
                        <img src={partnerdetail?.image} alt="" width={100} />
                    </span>
                </div>
