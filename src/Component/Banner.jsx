...
export default function Banner() {
  ...
  return (
    <div className='bg-blue-600 hover:bg-yellow-300'>
      {
        tblogs.map((blog) => (
        <div key={blog.$id} className='p-2 max-w-4xl mx-auto 0 grid sm:grid-cols-2 sm:gap-4'>
          ...
          <div className='w-full p-4 pt-5'>
              ...
              <h1 className='uppercase text-2xl font-bold line-clamp-1 sm:ml-4 text-blue-200'>{blog.title}</h1>
                <p className='text-justify line-clamp-2 sm:ml-4'>
                  {blog.desc}
                </p>
              <span className='flex gap-3 sm:mx-4 mt-[4px]'>
