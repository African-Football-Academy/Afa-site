...
function Login() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center relative bg-img2 bg-cover"
    >
          ...
          <div className="p-8 flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <h1 className="text-white font-black text-2xl uppercase tracking-[0.1em]">
                Con<span className="text-blue-400">nexion</span>
              </h1>
              <p className="text-blue-400 text-xs mt-1">Accédez à votre espace personnel</p>
            </div>
            ...
            <p className="text-center text-xs">
              <span className="text-blue-400">Pas encore de compte? </span>
              <Link to="/register" className="text-white font-black hover:text-blue-300 transition-colors uppercase tracking-widest">
                S'inscrire →
              </Link>
            </p>
